 ...
 * @Date         : 2025-01-27 08:40:24 +0100
 * @LastEditors  : Jie Wu j.wu@cern.ch
 * @LastEditTime : 2025-02-06 08:43:11 +0100
 * @FilePath     : HistFactoryModelUtils.cxx
 * @Description  :
 *
...
namespace RooStats
{
  namespace HistFactory
  {
    ...
    RooAbsPdf *getSumPdfFromChannel(RooAbsPdf *sim_channel)
    {
      ...
      if (verbose)
        std::cout << "Getting the RooRealSumPdf for the channel: " << sim_channel->GetName() << std::endl;
    ...
    void FactorizeHistFactoryPdf(const RooArgSet &observables, RooAbsPdf &pdf, RooArgList &obsTerms, RooArgList &constraints)
    {
      ...
      else if (id == typeid(RooSimultaneous) || id == typeid(HistFactorySimultaneous))
      { //|| id == typeid(RooSimultaneousOpt)) {
